...
// ********************************************************
params ["_trapProxy","_triggerActivatedBy", "_trap_height"];
...
_maceSphere setPos (getPos _trapProxy vectorAdd [0,0, 12]); // _trap_height to be used here according to tree type.
...
// ***************************************************************************
[_trapProxy,_mace,_maceSphere,_trigger] spawn JBOY_monitorFallingMaceTrap;
