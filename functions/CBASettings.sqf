...
// Throwable
["Columbia_CBA_remove_throwable", "EDITBOX", ["Throwable to Remove from AI"], [CBA_SETTINGS_COLUMBIA, "Throwable"], "vn_rdg2_mag,vn_molotov_grenade_mag", 1, {Columbia_CBA_remove_throwable = Columbia_CBA_remove_throwable splitString ","}, false] call CBA_fnc_addSetting;