...
["A - Columbia Vehicle", "Add STABO", {_this execVM "functions\columbia_zeus_addstabo.sqf";}, "\z\ace\addons\fastroping\UI\Icon_Waypoint.paa"] call zen_custom_modules_fnc_register;
